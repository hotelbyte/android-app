...
import org.hotelbyte.app.util.WellKnownAddresses;
...
public class AddressNameStorage {
    ...
    public ArrayList<AccountBean> getAsAddressbook() {
        ArrayList<AccountBean> erg = new ArrayList<AccountBean>();
        for (Map.Entry<String, String> entry : addressbook.entrySet()) {
            erg.add(new AccountBean(entry.getValue().toString(), entry.getKey().toString()));
        }
