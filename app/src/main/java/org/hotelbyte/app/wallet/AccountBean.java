...
public class AccountBean implements Comparable {
    ...
    public AccountBean(String name, String publicKey, BigInteger balance, byte type) {
        this.name = name;
    ...
    public AccountBean(String name, String publicKey) {
        this.name = name;
        this.publicKey = publicKey;
        this.balance = null;
        this.type = CONTACT;
    ...
    public int compareTo(@NonNull Object o) {
        return name.compareTo(((AccountBean) o).getName());
    }
}
